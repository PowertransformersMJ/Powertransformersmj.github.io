...
7. [`docs/MANTENIMIENTO-PREDICTIVO.md`](./docs/MANTENIMIENTO-PREDICTIVO.md) — **módulo Pruebas Eléctricas** · refactor del tablero TransformerOps a capas dominio/data/UI/shell · semáforo normativo congelado · Firestore realtime (interfaz en tiempo real · solo datos reales, sin seed de demostración) · scripts npm · cómo extender.
