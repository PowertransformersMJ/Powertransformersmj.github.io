...
/**
 * Apertura BREVE del texto (`99 §95`). Huecos: {MATRICULA}, {MVA}, {SUB}.
 */
export const APERTURA_BENEFICIOS = "El transformador de potencia {MATRICULA}, de {MVA} MVA, instalado en la subestación {SUB}, es de construcción especializada y reposición no inmediata. Los beneficios siguientes se refieren a su riesgo operativo de falla catastrófica.";
...
/** Cierre BREVE del texto (`99 §95`). */
export const CIERRE_BENEFICIOS = "El mantenimiento actúa sobre la probabilidad de la falla y, al recomponer las protecciones, sobre su severidad. Lo consumido del aislamiento sólido no se recupera; su degradación solo se contiene.";
 ...
 * `beneficio`: el renglón BREVE que sale en el texto (12-28 palabras, `99 §95`),
 *   condensado del amplio por 3 redactores → 3 revisores técnicos → 1 editor.
...
export const BENEFICIO_PRACTICA = Object.freeze({
  'SUB-PSM-01': Object.freeze({
    ...
    beneficio: "Detecta en servicio descargas parciales, sobrecalentamientos y degradación de la celulosa antes de que evolucionen a falla del aislamiento o arco interno con rotura de cuba.",
  ...
  'SUB-PSM-02': Object.freeze({
    ...
    beneficio: "Califica el estado dieléctrico y geométrico de bujes y devanados y sustenta la intervención antes de una explosión de buje, falla interna o colapso mecánico por cortocircuito.",
  ...
  'SUB-PSM-03': Object.freeze({
    ...
    beneficio: "Detecta entre ensayos fugas, deshidratante saturado y aisladores contaminados antes de que deriven en falla dieléctrica por humedad o bajo nivel de aceite, o en flameo externo.",
  ...
  'SUB-PSM-04': Object.freeze({
    ...
    beneficio: "Localiza puntos calientes en bornes y conexiones y pérdida de disipación en la refrigeración, antes de que deriven en falla de buje o falla térmica del aislamiento.",
  ...
  'SUB-PSM-05': Object.freeze({
    ...
    beneficio: "Expone la degradación de la trayectoria a tierra de cuba, neutro y descargadores antes de que una sobretensión no limitada provoque falla dieléctrica en devanados o bujes.",
  ...
  'SUB-C2-01': Object.freeze({
    ...
    beneficio: "Localiza y jerarquiza bajo carga puntos calientes en conexiones, bujes y radiadores antes de que deriven en falla de buje o en falla térmica del aislamiento.",
  ...
  'SUB-C2-02': Object.freeze({
    ...
    beneficio: "Expone etapas de refrigeración que no arrancan, bombas sin caudal y radiadores obstruidos antes de que la pérdida de disipación desemboque en falla térmica del aislamiento.",
  ...
  'SUB-C2-03': Object.freeze({
    ...
    beneficio: "Detecta la deriva de los termómetros y de sus ajustes antes de que una sobretemperatura sin alarma ni disparo lleve el aislamiento a falla térmica.",
  ...
  'SUB-C2-04': Object.freeze({
    ...
    beneficio: "Detecta con periodicidad reforzada fugas, caída de nivel de aceite, deshidratante saturado y bujes contaminados antes de que deriven en falla dieléctrica interna o flameo externo.",
  ...
  'SUB-C2-05': Object.freeze({
    ...
    beneficio: "Sigue, en un activo en deterioro, la evolución del aislamiento de devanados y bujes, y sustenta la intervención antes de una falla interna o explosión de buje.",
  ...
  'SUB-C2-06': Object.freeze({
    ...
    beneficio: "Califica la capacidad del descargador para limitar sobretensiones atmosféricas y de maniobra antes de que su degradación deje devanados y bujes expuestos a falla dieléctrica.",
  ...
  'SUB-C3-01': Object.freeze({
    ...
    beneficio: "Sella el ingreso de humedad y repone el nivel: reduce la probabilidad de falla dieléctrica interna y detiene el derrame que agravaría un incendio, sin secar el papel.",
  ...
  'SUB-C3-02': Object.freeze({
    ...
    beneficio: "Restituye la alarma por gases y el disparo del relé Buchholz, junto con el alivio de sobrepresiones menores: acota el escalamiento a arco interno con rotura de cuba.",
  ...
  'SUB-C3-03': Object.freeze({
    ...
    beneficio: "Deja probados disparos y enfriamiento forzado: reduce la probabilidad de que un defecto interno escale sin despeje a rotura de cuba o el aislamiento sufra falla térmica.",
  ...
  'SUB-C3-04': Object.freeze({
    ...
    beneficio: "Devuelve rigidez dieléctrica al aceite: reduce la probabilidad de descarga disruptiva con arco interno, efecto que solo perdura atendiendo el ingreso de humedad y el agua del papel.",
  ...
  'SUB-C3-05': Object.freeze({
    ...
    beneficio: "Anticipa conmutación incompleta y arco con sobrepresión; en OILTAP retira carbón del aceite, en VACUTAP comprueba ampollas de vacío y en NLTC desprende el óxido que calienta contactos.",
  ...
  'SUB-C3-06': Object.freeze({
    ...
    beneficio: "Retira ácidos y productos de oxidación, precursores de lodos que obstruyen la refrigeración: reduce la probabilidad de falla térmica del aislamiento, sin revertir el envejecimiento del papel.",
  ...
  'SUB-C3-07': Object.freeze({
    ...
    beneficio: "Extrae agua del aislamiento sólido: reduce la probabilidad de falla dieléctrica del devanado, incluida la originada por burbujas de vapor en sobrecarga, sin restituir el grado de polimerización.",
  ...
  'SUB-C3-M1': Object.freeze({
    ...
    beneficio: "Reactiva etapas de refrigeración y despeja radiadores: a igual carga baja el punto más caliente y la probabilidad de falla térmica del aislamiento, sin restituir la vida consumida.",
  ...
  'SUB-C3-M2': Object.freeze({
    ...
    beneficio: "Amplía la disipación y el margen térmico ante demanda creciente: reduce la probabilidad de falla térmica del aislamiento, sin elevar la potencia nominal ni restituir vida al papel.",
  ...
  'SUB-C4-01': Object.freeze({
    ...
    beneficio: "Retira ácidos y lodos: reduce la probabilidad de arco interno por falla dieléctrica y de falla térmica por canales obstruidos; el grado de polimerización perdido no se recupera.",
  ...
  'SUB-C4-02': Object.freeze({
    ...
    beneficio: "Reduce la humedad del aislamiento sólido y la probabilidad de falla dieléctrica del devanado, incluida la desencadenada por burbujas en sobrecarga, sin recuperar el grado de polimerización.",
  ...
  'SUB-C4-03': Object.freeze({
    ...
    beneficio: "Contiene la corrosión salina en las zonas intervenidas y reduce la probabilidad de perforación de cuba o radiador, con fuga de aceite e ingreso de humedad.",
  ...
  'SUB-C4-04': Object.freeze({
    ...
    beneficio: "Verifica o repone contactos y aceite en OILTAP, y ampollas de vacío en VACUTAP: reduce la probabilidad de arco sostenido con rotura del compartimiento del ruptor.",
  ...
  'SUB-C4-05': Object.freeze({
    ...
    beneficio: "Localiza o acota el defecto acreditado por gases disueltos o descargas parciales y orienta su corrección antes de que evolucione a arco interno con rotura de cuba.",
  ...
  'SUB-C4-06': Object.freeze({
    ...
    beneficio: "Retira de servicio el buje con aislamiento degradado y reduce la probabilidad de ruptura dieléctrica, que puede terminar en explosión, incendio y propagación a la cuba.",
  ...
  'SUB-C4-07': Object.freeze({
    ...
    beneficio: "Restituye protecciones mecánicas, refrigeración y hermeticidad: acota con disparo oportuno la severidad de una falla interna y reduce la probabilidad de falla térmica por refrigeración insuficiente.",
  ...
  'SUB-C4-08': Object.freeze({
    ...
    beneficio: "Somete la carga a límites y vigila el punto más caliente: mientras se cumpla, reduce la probabilidad de falla térmica o dieléctrica del devanado, sin recuperar vida consumida.",
  ...
  'SUB-C4-M2': Object.freeze({
    ...
    beneficio: "Traslada el activo degradado a un nodo de menor exigencia y criticidad: reduce la probabilidad de falla térmica y acota su consecuencia, sin mejorar su condición interna.",
  ...
  'SUB-C5-01': Object.freeze({
    ...
    beneficio: "Restituye el recubrimiento completo, contiene la corrosión salina y reduce la probabilidad de perforación de cuba, radiadores o tuberías, con fuga de aceite e ingreso de humedad.",
  ...
  'SUB-C5-02': Object.freeze({
    ...
    beneficio: "Acota la consecuencia de una falla interna, no su probabilidad: restituye disparo y alivio oportunos, que limitan el escalamiento del arco a rotura de cuba e incendio.",
  ...
  'SUB-C5-03': Object.freeze({
    ...
    beneficio: "Retira productos de oxidación del aceite y humedad del papel: reduce la probabilidad de arco interno por falla dieléctrica o térmica, sin restituir el grado de polimerización.",
...
export function redaccionBeneficiosPracticas(equipo, _diag, escogidas) {
  ...
  for (const a of lista) {
    ...
    // El nombre de la práctica se separa con raya: muchos breves ya llevan su
    // propio «acción: efecto», y dos «:» en un renglón se leían mal (`99 §95`).
