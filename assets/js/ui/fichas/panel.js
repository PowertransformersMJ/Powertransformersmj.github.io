 ...
 */
// Cinco por banda desde el 2026-09-10 (encargo del Ingeniero): A · trabajo,
// B · evidencia, C · operación y riesgo, D · CONSERVACIÓN DEL ACTIVO —riesgo de
// falla, usuarios, imagen corporativa, SAIDI/SAIFI, indisponibilidad y
// exposición regulatoria— y E · la automática anclada en datos medidos, que
// antes vivía suelta al final. La D afirma «riesgo de falla» solo en C3-C5: en
// C1 y C2 argumenta PRESERVAR la condición favorable, porque decir que una
// banda favorable está en riesgo sería falso en un papel que se firma.
export const ALCANCE_MTTO_OPC = Object.freeze([
  ...
  { t: 'C1·D · Conservación del activo', cond: 1, v: 'El transformador de {MVA} MVA de la subestación {SUB} se encuentra en condición muy buena, la banda de menor probabilidad de falla; conservar el activo, en esta banda, es preservar esa condición para que el deterioro no lo desplace hacia las bandas que lo colocan en riesgo de falla. Con ese propósito, el alcance comprende {ACCIONES}. Una probabilidad de falla baja no reduce la consecuencia, que sigue dependiendo de la criticidad por usuarios aguas abajo; por eso, preservar la condición protege la continuidad del suministro de los usuarios asociados a la instalación, la percepción del servicio y la reputación de la empresa, la disponibilidad del activo y los indicadores de calidad del servicio SAIDI y SAIFI, y el cumplimiento del esquema de calidad del servicio de la distribución establecido en la Resolución CREG 015 de 2018. El seguimiento se orienta a advertir cualquier desviación mientras su corrección todavía es menor.' },
  { t: 'C1·E · Automática · datos medidos', cond: 1, auto: 'alcance_mtto' },
  { t: 'C2·A · Trabajo y subsistemas', cond: 2, v: 'El trabajo contratado sobre el transformador de {MVA} MVA de la subestación {SUB} comprende {ACCIONES}. La intervención recae sobre los subsistemas accesibles desde el exterior de la cuba: hermeticidad, sistema de preservación, sistema de refrigeración, tablero de control e instrumentación de temperatura con su señalización a las protecciones. No contempla apertura de la cuba, acceso a la parte activa, intervención del conmutador bajo carga o sin carga ni tratamiento del aceite aislante: cualquiera de ellos reiniciaría la línea base de gases disueltos y de compuestos furánicos, y toda evaluación posterior se haría contra un nuevo cero. Al cierre, los accesorios quedan verificados, la hermeticidad comprobada y la instrumentación contrastada, sin intervención del aislamiento sólido; el completado de aceite se limita al del muestreo y las juntas intervenidas.' },
  ...
  { t: 'C2·D · Conservación del activo', cond: 2, v: 'En condición buena, el transformador de {MVA} MVA de la subestación {SUB} conserva una probabilidad de falla menor; lo que justifica actuar es que una desviación incipiente, si progresara, lo llevaría a las bandas en que la condición ya lo coloca en riesgo de falla. Conservar el activo es, aquí, sostener la condición favorable deteniendo esa progresión en su origen; a ese fin, el alcance comprende {ACCIONES}. De la condición depende la probabilidad; de la criticidad por usuarios aguas abajo, la magnitud de lo que una falla comprometería: el suministro a los usuarios asociados a la instalación, la percepción que estos tienen del servicio y la imagen corporativa de la compañía, los indicadores de calidad del servicio SAIDI y SAIFI junto con la disponibilidad de la unidad, y la posición de la empresa frente al esquema de calidad del servicio de la distribución que fija la Resolución CREG 015 de 2018. La intervención no parte de una falla próxima, que la condición buena no sustenta: parte de impedir que la señal incipiente la vuelva probable.' },
  { t: 'C2·E · Automática · datos medidos', cond: 2, auto: 'alcance_mtto' },
  ...
  { t: 'C3·D · Conservación del activo', cond: 3, v: 'La condición media del transformador de potencia de {MVA} MVA instalado en {SUB} ya lo coloca en riesgo de falla: el deterioro acumulado eleva su probabilidad de falla, aunque sin alcanzar las bandas pobre y muy pobre. Conservar el activo en esta banda es contener ese deterioro antes de que lo lleve allí, donde la probabilidad es mayor y la consecuencia, fijada por la criticidad por usuarios aguas abajo, no disminuye. Una falla no programada, según el respaldo disponible, interrumpiría el suministro a los usuarios asociados a la instalación; además, deterioraría la percepción del servicio y la reputación de la empresa, aumentaría la indisponibilidad del activo, afectaría los indicadores de calidad del servicio SAIDI y SAIFI y expondría a la compañía ante el esquema de calidad del servicio de la distribución de la Resolución CREG 015 de 2018. Para conservar la unidad en operación, el alcance comprende {ACCIONES}. La conservación se orienta a acotar la probabilidad de falla; el envejecimiento del aislamiento sólido se contiene, no se revierte.' },
  { t: 'C3·E · Automática · datos medidos', cond: 3, auto: 'alcance_mtto' },
  { t: 'C4·A · Intervención y entrega', cond: 4, v: 'La intervención correctiva mayor sobre el transformador de {MVA} MVA de la subestación {SUB} comprende {ACCIONES}. Recae sobre los subsistemas que el diagnóstico señale como origen de la condición —parte activa y aislamiento sólido, cuba y sistema de preservación, conmutador, bujes, refrigeración, tablero de control con sus protecciones e instrumentación—. El activo se conserva en operación: la reposición no pertenece a este documento y se sustenta en la propuesta a Plan de Inversión. Se entrega con lo intervenido verificado por ensayo y sin alterar lo ajeno al alcance; se exceptúa el aislamiento sólido, cuyo envejecimiento la intervención contiene pero no deshace. Cuando hay tratamiento del aceite, este reinicia la línea base de gases disueltos y de compuestos furánicos: la evaluación posterior se hace contra el nuevo cero. Los niveles de entrega se fijan según los resultados del diagnóstico del activo.' },
  ...
  { t: 'C4·D · Conservación del activo', cond: 4, v: 'La condición pobre del transformador de {MVA} MVA de la subestación {SUB} lo coloca en riesgo de falla: expresa una probabilidad de falla alta, y la criticidad por usuarios aguas abajo determina cuánto pesaría esa falla. De materializarse, esa falla expone a los usuarios asociados a la instalación a la interrupción del suministro, afecta la percepción del servicio y la imagen corporativa de la empresa, compromete los indicadores de calidad del servicio SAIDI y SAIFI y la disponibilidad del activo, y aumenta la exposición regulatoria frente al esquema de calidad del servicio de la distribución definido en la Resolución CREG 015 de 2018. Conservar el activo en esta banda exige actuar con prioridad y no solo vigilar: para mantenerlo en operación y reducir su probabilidad de falla, el alcance comprende {ACCIONES}. La intervención se orienta a las variables que admiten corrección; el envejecimiento ya consumido del aislamiento sólido no se recupera y queda bajo seguimiento.' },
  { t: 'C4·E · Automática · datos medidos', cond: 4, auto: 'alcance_mtto' },
  { t: 'C5·A · Sostener hasta la salida', cond: 5, v: 'Sobre el transformador de {MVA} MVA de la subestación {SUB}, en condición muy pobre, se ejecuta un alcance que comprende {ACCIONES}, dirigido a sostener la operabilidad hasta la salida del activo y no a extender su vida técnica. Cada subsistema intervenido queda en condición de operación acotada y verificable. Todo tratamiento de aceite o de aislamientos que ese alcance incluya reinicia la línea base de gases disueltos y de compuestos furánicos, contra la cual se contrasta la verificación posterior. La decisión sobre el destino del activo no pertenece a este alcance: se sustenta en la propuesta a Plan de Inversión, a la que este documento aporta la evidencia de condición. El activo se entrega con inventario de componentes recuperables, expediente técnico consolidado y ruta de desincorporación ambiental, documental y patrimonial.' },
  { t: 'C5·B · Evidencia de fin de vida', cond: 5, v: 'La calificación muy pobre se sustenta en la evidencia ponderada del índice de salud: tendencia de gases disueltos, rigidez dieléctrica, tensión interfacial y número de neutralización, compuestos furánicos y grado de polimerización estimado a partir de ellos, edad, cargabilidad, protecciones y telecontrol, y hermeticidad. Sobre esa base, el alcance definido para el transformador de {MVA} MVA de la subestación {SUB} comprende {ACCIONES}. La despolimerización de la celulosa es irreversible y la edad solo acumula: se informa la recuperación de variables tratables, no del agregado. Todo tratamiento del aceite reinicia la línea base de gases disueltos y compuestos furánicos, y la verificación posterior se contrasta contra ese nuevo cero. El resultado se incorpora al expediente de condición del activo, que es lo que este documento aporta a la propuesta a Plan de Inversión: la evidencia no habilita recuperación.' },
...
export const BENEF_MTTO_OPC = Object.freeze([
  { t: 'C1 · Conservar y vigilar', cond: 1, v: '· Condición demostrable: la línea base por variable convierte un buen estado presunto en un estado verificado, y deja la unidad de {MVA} MVA con historial trazable para sustentar cualquier decisión posterior.\n· Detección temprana: toda desviación futura se mide contra una serie propia del activo, y se advierte mientras la corrección todavía es de bajo costo.\n· Continuidad del suministro: reduce la probabilidad de un evento no anticipado en {SUB} y su efecto sobre los indicadores de calidad (SAIDI/SAIFI).\n· Costo evitado: sostener el seguimiento cuesta una fracción del correctivo que exigiría una banda más abajo.\n· Mejora posible sin intervención mayor: las variables de protecciones e instrumentación y de hermeticidad pueden elevar su calificación si el diagnóstico revela oportunidades.\n· Seguridad y ambiente: la vigilancia de la hermeticidad y del régimen térmico contiene los escenarios de derrame y de sobrecalentamiento.' },
  { t: 'C2 · Controlar y seguir', cond: 2, v: '· Señal caracterizada: la tendencia se confirma o se descarta y se atribuye a una causa, con decisión documentada — que es lo que evita intervenir a ciegas.\n· Degradación acelerada evitada: corregir la causa incipiente mientras es de baja intensidad impide la progresión a una banda de intervención mayor y menos reversible.\n· Evidencia preservada: al no tratar el aceite se conserva la línea base de gases y compuestos furánicos, sin la cual la tendencia posterior no es interpretable.\n· Disponibilidad del suministro en {SUB}: menor probabilidad de salida forzada y de la energía no suministrada asociada.\n· Costo proporcional: el refuerzo de vigilancia es la respuesta más económica del ciclo frente al correctivo que evita.\n· Seguridad de personas e instalaciones: las causas externas que se corrigen —conexiones, refrigeración y hermeticidad— son las que derivan en sobrecalentamiento y derrame.' },
...
export function montarPanelFichas(contenedor, opciones = {}) {
  ...
  // Emisión con firmas del equipo en confirmación (`99 §99`).
  let emision = null;          // { plan, lecturas, equipo }
  let hoja = 'ficha';
  let aviso = '';
  ...
  function selectorRedaccion(e, campo) {
    ...
    // Las propuestas del documento de mantenimiento van por CONDICIÓN de salud,
    // y el módulo ya sabe la del equipo: se señala cuál le toca. No se
    ...
    const grupo = (c) => '<optgroup label="Condición ' + c + ' · ' + esc(nombreCondicion(c))
      ...
      + '</optgroup>';
    // Desde el 2026-09-10 la automática del alcance vive DENTRO de cada banda
    // (la «E», encargo del Ingeniero). La entrada suelta del final se conserva
    // para el equipo SIN condición, que no tiene banda donde encontrarla; pero
    // si el equipo sí tiene banda y esa banda ya trae su automática, repetirla
    // bajo «Sin condición» sería enseñar dos veces la misma opción. Beneficios
    ...
    return '<div class="ftm-alcance">'
      ...
      + '<span class="ftm-alcance-hint">' + pista + '</span></div>'
  ...
  function hojaFicha(e) {
    ...
    return '<div class="ftm-hoja">'
      ...
      // referente a inversión queda allí, así que este documento no lo lleva.
      + (documento === 'salud'
        ? ''
        : banda('Presupuesto') + bloquePresupuesto(e))
  ...
  /* ── EMISIÓN CON FIRMAS DEL EQUIPO (`99 §99`) ─────────────────────────────
     Pedido del Ingeniero: el Excel lleva la firma de todos. Botón aparte (la
     descarga normal sigue con solo la firma propia), tabla de confirmación
     casilla → firmante → firma → origen, y REGISTRO de la emisión: sin registro
     no hay descarga. Las firmas salen LIMPIAS, sin marca (decisión del
     Ingeniero, §99.11); el folio va en el nombre del archivo y en el registro.
     El Excel circula firmado tal cual: no se emite con casillas [PENDIENTE]. */
  function custodiaDisponible() {
    try { return !!(cfg.firmasEquipo && cfg.firmasEquipo.disponible()); } catch (_) { return false; }
  }

  /** SHA-256 (hex) de unos bytes, con la API del navegador. */
  async function huellaBytes(bytes) {
    const buf = await crypto.subtle.digest('SHA-256', bytes);
    return [...new Uint8Array(buf)].map((b) => b.toString(16).padStart(2, '0')).join('');
  }
  async function huellaDataUrl(dataUrl) {
    const b64 = String(dataUrl).split(',')[1] || '';
    const bin = atob(b64);
    const out = new Uint8Array(bin.length);
    for (let i = 0; i < bin.length; i++) out[i] = bin.charCodeAt(i);
    return huellaBytes(out);
  }

  /**
   * Casillas [PENDIENTE] de la ficha. La emisión con firmas del equipo NO sale
   * con ellas: ese Excel circula firmado tal cual, y completarlo a mano después
   * dejaría las firmas sobre un contenido que no es el registrado (§99.11).
   */
  async function pendientesDe(eq, estado) {
    const mod = cfg.exportador ? null : await import('./exportar-planificacion.js');
    return mod && mod.pendientesFichaPlan ? mod.pendientesFichaPlan(eq, estado || estadoParaExportar(eq)) : [];
  }
  function textoPendientesEquipo(faltan) {
    const n = faltan.reduce((s, f) => s + f.campos.length, 0);
    return 'No se emite con las firmas del equipo mientras la ficha tenga ' + n
      + (n === 1 ? ' casilla [PENDIENTE]' : ' casillas [PENDIENTE]') + ':\n\n'
      + faltan.map((f) => '• ' + f.campos.join(' y ') + ': ' + f.motivo).join('\n')
      + '\n\nEse Excel circula firmado tal cual: complételas y vuelva a intentar. '
      + '«Exportar Excel» sigue sirviendo para descargar un borrador.';
  }
  ...
  async function prepararEmisionEquipo() {
    ...
    try {
      ...
      alert('No se pudieron leer las firmas del equipo. Revise la conexión e intente de nuevo.');
    } finally {
  ...
  function pintarEmision(avisoCambio) {
    ...
    let conFirma = 0;
    for (const c of emision.plan) {
      const f = FIRMAS.find((x) => x.k === c.k);
      const tr = cuerpo.insertRow();
      tr.insertCell().textContent = f ? f.rol + (f.segundo ? ' (segundo firmante)' : '') : c.k;
      tr.insertCell().textContent = c.nombre || '—';
      const celda = tr.insertCell();
      const origen = tr.insertCell();
      const src = c.origen === 'propia' ? firmaSesion.dataUrl
        : (c.origen === 'equipo' ? (emision.lecturas.get(c.id) || {}).dataUrl : null);
      if (src) {
        conFirma++;
        const img = document.createElement('img'); img.alt = 'Firma de ' + c.nombre; img.src = src; img.className = 'ftm-emision-img';
        celda.appendChild(img);
        if (c.origen === 'propia') origen.textContent = 'Su firma propia';
        else {
          const a = (emision.lecturas.get(c.id) || {}).autorizacion || {};
          origen.textContent = 'Firmas del equipo · autorizada el '
            + String(a.fecha || '').split('-').reverse().join('/') + ' · ' + (a.medio || '');
        }
      } else {
        celda.textContent = 'SIN FIRMA';
        origen.textContent = c.motivo;
      }
    }
    const nota = document.createElement('p'); nota.className = 'ftm-emision-nota';
    nota.textContent = 'Las firmas salen limpias. La emisión queda en el registro interno del SGM (quién, cuándo, '
      + 'qué firmas y la huella del archivo) y su folio va en el nombre del archivo. Sin registro no se descarga. '
      + 'Si cambia un firmante, esta tabla se cierra y hay que volver a confirmar.';
  ...
  /** Vuelve a comprobar (ficha, pendientes y huella de cada firma), arma el Excel con las firmas limpias, lo REGISTRA y solo entonces lo descarga. */
    ...
    try {
      ...
      for (const c of vivo) {
        if (c.origen === 'propia' && firmaSesion.dataUrl) {
          ...
          if (!l) throw new Error('Falta la firma de ' + c.nombre + '; no se emitió.');
          // La huella sale de los BYTES leídos, no de los metadatos: si la imagen
          // se cambió por fuera de la pantalla, no coincide y no se emite (§99.11).
          const huella = await huellaDataUrl(l.dataUrl);
          if (huella !== l.huella) throw new Error('La firma de ' + c.nombre + ' no es la que se registró al subirla; no se emitió.');
          firmas[c.k] = { dataUrl: l.dataUrl, rel: await medirFirma(l.dataUrl) };
