...
| Señal | Valor |
|---|---|
| **Build** | 🟢 `npm test` (lint + `node --test tests/*`) **1052/1052 verde** (2026-06-07, +motor multi-norma). |
...
| **Producción** | `main` → GitHub Pages (`pages.yml`). `git fetch` 2026-06-07: `origin/main` = `dcdaba9` (incluye ADR-011 base, scorecard normativo). `origin/DESARROLLO` = `5d2cdfd`. **HEAD local adelantado: `fe15ae9` (resistencia 2%/badges) + ADR-012 multi-norma sin commitear** → pendiente push de ambos (director). |
