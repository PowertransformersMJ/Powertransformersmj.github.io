...
|---|---|
| **Misión ahora** | **FICHAS TÉCNICAS, por partes** (cola viva → `docs/cola-fichas-tecnicas.md`). **Publicado 09-25** (`098dbff`, `0499e0d`, `01c921a`): `§93` Valor Real en blanco · `§94` calendario de años · `§95`-`§97` beneficios por práctica (breves, técnicos, sin marcas de fábrica) · `§98` firma estampada · `§99` firmas del equipo · `§100` firmas en Firestore · `§101`-`§102` vista previa del Excel + PDF y cinco firmas en pantalla (`8017e0a`, en vivo). |
