...
| Señal | Valor |
|---|---|
| **Build** | 🟢 `npm test` (lint + `node --test tests/*`) **1110/1110 verde** (2026-06-08, +Tablero MULTI-AÑO: cada prueba con todos los años superpuestos + filtro de año por prueba, validado con workflow de PREVIEW, ADR-024). |
