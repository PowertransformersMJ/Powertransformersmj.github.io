...
| Señal | Valor (al **2026-09-16**) |
|---|---|
| **Misión ahora** | **`99 §77` (09-16)**: OE/OS en el **registro del equipo** (Firestore) — crear ≠ editar, versión, lápida, subida orden por orden, sin cédulas (**L-91**). Falta la escritura real en producción (TODO-62). |
| **Build** | 🟢 **1677 pass / 0 fail / 2 skip** + `lint:html` limpio + **77 tests de reglas** (34 Firestore + 43 Storage; Storage necesita el emulador de Firestore al lado — L-78). · verificado-vivo: 2026-09-16 · CI y Deploy en VERDE, comprobado en el log (esperar SIEMPRE a que el Deploy termine — L-65) |
