...
| **Deuda crítica** | ✅ billing resuelto (prueba gratuita había expirado; Ingeniero activó cuenta completa 2026-07-23 y Claude desplegó — CF vivas). 🔴 Restan del Ingeniero: (a) **GitHub Support** purga `refs/pull/*`; (b) **ratificar TODO-04** + entregar MO.00418 (per-clase); (c) probar B/E + extracción IA en vivo; (d) alerta de presupuesto GCP (recomendada, free-tier sagrado). |
