...
| **Parque real** | **206 TX**, **0 ficticios**, **3.831,3 MVA** (CASACARA pasó de 5 a 2 MVA, `99 §74.9`). ⚠️ **Sin Índice de Salud**: salud, matriz y priorización vacías hasta el import — el dato ya existe y está verificado en el Excel (`99 §69`, TODO-34) · verificado-vivo: 2026-08-21 |
