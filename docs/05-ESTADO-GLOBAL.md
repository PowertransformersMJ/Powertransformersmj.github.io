...
|---|---|
| **Misión ahora** | **FICHAS TÉCNICAS, por partes** (cola viva → `docs/cola-fichas-tecnicas.md`). **Publicado 09-25** (`098dbff`, `0499e0d`): `§93` Valor Real vacío en blanco · `§94` calendario de años · `§95` beneficios breves por práctica · `§96` Mantenimiento sin marcas de fábrica. Antes (09-23): `§87` el Excel que se firma · `§88-§89` firmantes · `§90`-`§92`. |
