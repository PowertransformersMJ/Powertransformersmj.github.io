...
| **Build** | 🟢 **1696 pass / 0 fail / 2 skip** + `lint:html` limpio + **91 tests de reglas** (48 Firestore + 43 Storage; Storage necesita el emulador de Firestore al lado — L-78) + candado `guardia:cedulas`. · verificado-vivo: 2026-09-16 · CI y Deploy en VERDE, comprobado en el log (L-65) |
