...
| Señal | Valor |
|---|---|
| **Build** | 🟢 `npm test` (lint + `node --test tests/*`) 1004/1004 verde (2026-06-07). |
...
| **Producción** | `main` → GitHub Pages (`pages.yml`). `git fetch` 2026-06-07: `origin/main` = `2bc0ca3` (**lotes 4–5 EN PRODUCCIÓN**, PR #119); `origin/DESARROLLO` = `1f51b70`; **HEAD local = `4548fb6`** (lote 6 sin pushear: `2534bcb` código + `4548fb6` mirror). **Pendiente push (director)**: lote 6. |
