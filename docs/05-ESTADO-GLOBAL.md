...
| **Build** | 🟢 **1460 pass / 0 fail / 2 skip** + `lint:html` limpio + **51 tests de reglas** (8 Firestore + 43 Storage; Storage necesita el emulador de Firestore al lado — L-78). · verificado-vivo: 2026-09-01 · CI y Deploy en VERDE, comprobado en el log (esperar SIEMPRE a que el Deploy termine — L-65) |
...
| **Parque real** | **208 TX** · **3.838,5 MVA** · **208 con Índice de Salud** (39·86·54·28·1) · 0 discrepancias UUCC · 3 sin UC (monofásicos de N3, `99 §74.13`) · conformidad 99,5% (`99 §74.11`) · verificado-vivo: 2026-09-08 |
