...
|---|---|
| **Misión ahora** | **`99 §78` (09-16)**: cédulas desde un directorio privado en Firestore + candado de datos personales (**L-93**). Antes `§77` (registro OE/OS). Pendiente: TODO-62/63. |
| **Build** | 🟢 **1696 pass / 0 fail / 2 skip** + `lint:html` limpio + **93 tests de reglas** (50 Firestore + 43 Storage; Storage necesita el emulador de Firestore al lado — L-78) + candado `guardia:cedulas`. · verificado-vivo: 2026-09-16 · CI y Deploy en VERDE, comprobado en el log (L-65) |
