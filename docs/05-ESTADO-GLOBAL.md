...
| **Deuda crítica** | 🔴 **ACCIÓN INGENIERO**: (a) **billing Firebase DESHABILITADO — CONFIRMADO 2026-07-23**: las CF de IA (extracción/narrativa) **CAÍDAS en prod** (HTTP 500) y deploy bloqueado; reactivar en console.developers.google.com/billing/enable?project=lordpowertransformersmj → Claude despliega (comando en `10 §RETOMAR`); (b) **GitHub Support** purga `refs/pull/*`; (c) **ratificar TODO-04** + entregar MO.00418 (per-clase). |
