...
| **Producción** | `main` → GitHub Pages (`pages.yml`). `git fetch` 2026-06-08: `origin/main` = `f3951b4` (arco completo ADR-003→014 EN PRODUCCIÓN). `origin/DESARROLLO` = `a4a029e` = HEAD local (en sync). **Nada pendiente de push.** |
