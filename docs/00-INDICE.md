...
| §42 | ADR-042 — Excitación: vista **"Resumen (todo)"** (valores mA + desviación + tablas apiladas, ahora por defecto) + **gating de tablas** (solo al acotar a 1 año o 1 nivel → evita sobrecarga) + chip "Patrón"→"Valores (mA) por fase" + **fix `reset`** (mutar Sets en sitio, no reasignar — closures huérfanos; **L-54**) | 822 |
