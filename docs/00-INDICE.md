...
| §69 | ADR-069 — La hoja TX_Potencia leída de verdad: los «62 omitidos» del simulacro no eran hojas sin datos sino **57 equipos reales** cuya cabecera está en la fila 2. La hoja da 208 equipos válidos con Índice de Salud y 1.655.376 usuarios (cierra TODO-34). La `CONDICION` del Excel y el índice recalculado solo coinciden en el 46%: manda la cargabilidad (18 equipos ≥90%, 5 por encima del 100%), y ASTREA mide un 250% imposible con su evaluación en «óptimo» ⟦OPUS-5⟧ | 1637 |
