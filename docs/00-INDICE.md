...
| §75 | ADR-075 — **Fichas Técnicas**: 5 afirmaciones falsas del papel firmado corregidas (dinero ×100, familia de la UC, ensayos en 0, «0 usuarios», inversión en mantenimiento); 5 redacciones por banda con conservación del activo; alcance que argumenta cada actividad y define las condiciones; matriz a color; municipio automático. **L-86..89** ⟦OPUS-5⟧ | 2642 |
| §76 | ADR-076 — **Órdenes de Materiales** al día con la versión del 8-sep, sin sus firmas ni cédulas y con el parque de Firestore; la validación cazó que recuperar una orden devolvía siempre la primera persona. **L-90** ⟦OPUS-5⟧ | 2964 |
