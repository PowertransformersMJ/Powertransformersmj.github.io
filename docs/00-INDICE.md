...
| §75 | ADR-075 — **Fichas Técnicas, tanda larga**: cinco afirmaciones falsas del papel firmado (el dinero con centavos entraba **×100** al PE.02081; la UC llamaba «trifásico» a un monofásico; el 0 de «no lo sé» se imprimía como ensayo; «alcanza 0 usuarios»; y el documento de mantenimiento proponía **reposición** contra la orden del 09-09). Luego el alcance ofrece las **7 macroactividades**, **argumenta** cada actividad (36 sustentos, 48 correcciones de un revisor normativo) y **define** las condiciones que el activo presenta; 5 redacciones por banda (con **conservación del activo**); municipio automático; matriz de riesgo a color con el activo encerrado. **L-86..89** ⟦OPUS-5⟧ | 2642 |
