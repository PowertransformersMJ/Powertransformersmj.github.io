...
| ~~**CF-25**~~ | ✅ **HECHO en rama (`§88`/`§89`)**: la lista dictada por el Ingeniero va en la ficha y en el Excel; espera su visto bueno al preview. Antes: **los firmantes no llegaban al Excel** (solo la fecha). ¿El formato admite el nombre impreso o exige escribirlo a mano sobre la línea? | Imprimirlos, como la fecha |
