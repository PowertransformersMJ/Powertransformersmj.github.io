...
> Qué pasó → `05` y `99 §75` (**§75.9-75.10**: el alcance ofrece las 7 macroactividades y lo referencial dejó de contratarse entero — **L-87**) (**no se repite aquí**, §G.3 propiedad). Lección: **L-86** — *una
