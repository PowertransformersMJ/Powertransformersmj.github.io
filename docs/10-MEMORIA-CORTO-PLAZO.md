...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23/24**: `§87`-`§92` (Excel que se firma, firmantes, alcance, fechas, beneficios por práctica). `§93` Valor Real vacío ⇒ en blanco (en rama `7716388`, preview entregado, esperando su «procede»). Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
