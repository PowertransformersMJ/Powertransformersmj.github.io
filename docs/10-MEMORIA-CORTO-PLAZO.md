...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23** (`f3411fb`): Tanda B (`§87`), firmas (`§88`-`§89`), alcance sin acciones (`§90`). Abierto: ¿Valor Real vacío ⇒ `[PENDIENTE]` (así quedó) o blanco? Nuevos: CF-35..39. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
