...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23/25**: `§87`-`§95` (Excel que se firma, firmantes, alcance, fechas, beneficios; `098dbff`: Valor Real en blanco, calendario de años, beneficios breves). En rama: `§96` nada marcado de fábrica. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
