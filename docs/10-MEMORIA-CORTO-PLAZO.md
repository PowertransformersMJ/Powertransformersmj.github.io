...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)** (auditada 09-21, 9 agentes sobre el módulo real). ✅ **CF-01..CF-04** (`§82-§85`). ⏭️ **SIGUIENTE: Tanda B**, el Excel que se firma (**CF-05 · CF-06 · CF-32**). Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
