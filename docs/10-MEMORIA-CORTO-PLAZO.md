...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23/25**: `§87`-`§96` (último: `0499e0d`). En rama: `§97` beneficios técnicos · `§98` firma estampada (él sube su PNG en «Mi firma»). Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
