...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23/24**: `§87`-`§92` (Excel que se firma, firmantes, alcance, fechas, beneficios por práctica). En rama, esperando su «procede»: `§93` Valor Real vacío ⇒ en blanco · `§94` Año de entrada con calendario · `§95` Beneficios breves por práctica. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
