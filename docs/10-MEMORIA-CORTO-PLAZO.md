...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). 🟡 **EN RAMA, SIN PUBLICAR**: Tanda B (`§87`) y firmas (`§88`-`§89`). NO fusionar a `main` sin su visto bueno al preview ni su respuesta (Valor Real vacío: ¿`[PENDIENTE]` o blanco?). Nuevos: CF-35..39. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
