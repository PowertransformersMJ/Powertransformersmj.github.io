...
| **TODO-05** | Validar extracción IA E2E (1 PDF real, Sonnet) tras fix auto+thinking; luego extras de maqueta (callout, barras rayadas, lista informes) | 🔄 en curso | prueba del director |
