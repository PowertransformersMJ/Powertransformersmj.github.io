...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). 🟡 **Tanda B (CF-05/06/32) EN RAMA, SIN PUBLICAR** (`99 §87`): NO fusionar a `main` sin su visto bueno al preview (artifact «El Excel que se firma») ni su respuesta: ¿Valor Real vacío ⇒ `[PENDIENTE]` o en blanco? Nuevos: CF-35..38. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
