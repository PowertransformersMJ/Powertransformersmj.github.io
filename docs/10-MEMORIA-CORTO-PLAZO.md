...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS — lista viva, auditada 09-21 → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)** (9 agentes sobre el módulo real; reemplaza los «31 hallazgos» de `§75`, que no tenían lista). **7 graves míos** (✅ `§83` lo redactado ya no se pierde · la carga tardía borra el listado · el pie declara un origen falso · el diagrama reaparece sobre otro equipo · el Valor Real y el Sistema no llegan al Excel · casillas de plata en blanco · el equipo sin usuarios firma «criticidad mínima» · dos criterios para el no evaluado · «plan registrado» que salió de la norma · 7 actividades sin su sustento) + **12 que esperan UNA respuesta tuya** (CF-20..CF-31) + 6 datos/decisiones tuyos. ✅ **(a) CERRADO** (`§82`). ✅ Tanda A (`§84`). ⏭️ **SIGUIENTE: Tanda B**, el Excel que se firma (CF-05 · CF-06 · CF-32 + CF-22/CF-25). | 🔴 |
