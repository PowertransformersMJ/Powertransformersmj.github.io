...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). 🟡 **EN RAMA, SIN PUBLICAR**: Tanda B (`§87`) y firmas con forma de Excel (`§88`). NO fusionar a `main` sin su visto bueno ni su respuesta (Valor Real vacío: ¿`[PENDIENTE]` o blanco?; parámetros de firmas). Nuevos: CF-35..38. Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
