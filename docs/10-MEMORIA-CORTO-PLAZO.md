...
| **TODO-35/58** | **Cola de FICHAS TÉCNICAS → hoja [`cola-fichas-tecnicas.md`](cola-fichas-tecnicas.md)**. ✅ **CF-01..CF-04** (`§82-§85`). ✅ **PUBLICADO 09-23**: `§87`-`§91`. 🟡 **EN RAMA**: `§92` beneficios por práctica, esperando su visto bueno al texto. Abierto: ¿Valor Real vacío ⇒ `[PENDIENTE]` o blanco? Los doce **CF-20..CF-31 ya autorizados en bloque** (09-22) entran con su tanda. | 🔴 |
