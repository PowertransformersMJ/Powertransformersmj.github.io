...
| **TODO-29** | 🔴 **Bóveda sin remoto** (decisión suya, ADR-059): UN disco con material real de cliente y 127 MB de fotos de campo irrepetibles; el commit es la única red. Si algún día hay copia real → `lastOffsiteBackup` del manifest. | 🟡 decidido |
